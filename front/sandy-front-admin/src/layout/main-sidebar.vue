          ...
          >
            ...
            >
              <div
                ...
                :class="[
                  'menu-left-item',
                  {'menu-left-active': selectLeftId === menu.id}
                ]"
              ...
              >
                ...
                <span
                  class="item-text"
                  :title="menu.menuName.length > 4 ? menu.menuName : ''"
...
const gotoRouteHandle = menu => {
  if (router.history.current.name === menu.path) {
    expandMenuList.value = []
    commonStore.updateSidebarFold(true)
    sessionStorage.setItem('isExpand', '0')
    commonStore.updateSelectRightId('')
